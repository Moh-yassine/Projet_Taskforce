 ...
 */
final class Version20250910112559 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE task_assignment (id INT AUTO_INCREMENT NOT NULL, task_id INT NOT NULL, user_id INT NOT NULL, role VARCHAR(20) NOT NULL, assigned_at DATETIME NOT NULL, INDEX IDX_2CD60F158DB60186 (task_id), INDEX IDX_2CD60F15A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
