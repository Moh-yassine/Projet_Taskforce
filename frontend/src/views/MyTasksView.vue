        ...
        <div class="nav-section account-section">
          ...
          <div class="account-info">
            ...
            <div class="account-details">
              ...
              <div class="account-member-since">Membre depuis: {{ user?.createdAt ? formatDate(user.createdAt) : 'N/A' }}</div>
            </div>
          </div>
          ...
          <div class="task-details">
            ...
            <div class="task-info">
              ...
              <div v-if="task.assignee" class="task-assignee">
                <strong>Assigné à:</strong> {{ task.assignee.firstName }} {{ task.assignee.lastName }}
              </div>
